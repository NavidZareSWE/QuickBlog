...
const AddBlog = () => {
  ...
  const generateContent = async () => {
    try {
      if (!title)
        return toast.error("Please enter a title to generate a blog!");
      setIsLoading(true);
      ...
      if (data.success)
        /**
         * Parse markdown to HTML (unsanitized - sanitize output before rendering).
         * ⬇️ Low-level compiler for parsing markdown without caching
         * or blocking for long periods of time.
         * Read More: https://github.com/markedjs/marked
         */
