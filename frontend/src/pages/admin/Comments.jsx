...
import { comments_data } from "../../assets/images/assets";
import CommentTableItems from "../../components/module/admin/CommentTableItems";
    ...
    <div className="flex-1 pt-5 px-5 sm:pt-12 sm:pl-16 bg-blue-50/50">
      <div className="flex justify-between items-center max-w-3xl">
        ...
        <div className="flex gap-4">
          {/* 
  The class "shadow-custom-sm" applies a small shadow effect 
  to an element, enhancing its visual depth. The specific 
  shadow properties are defined in the associated CSS.
*/}
